...
[![Typing SVG](https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=600&duration=4000&pause=100&color=B2A5FF&center=true&vCenter=true&width=800&height=80&lines=Building+software+close+to+the+hardware;Computer+Systems+for+Space+Applications;Aerospace+Computing+Research;Building+Reliable+Software+for+Critical+Systems)](https://git.io/typing-svg)


## 🛰️ Current Focus
Developing real-time systems in C/C++ | Exploring flight software architectures | Researching reliable computing for aerospace applications | Building simulations for autonomous systems
</div>
...
``` c
printf("Building software for systems beyond Earth.\n");
```
