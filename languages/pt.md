...
<img src="https://readme-typing-svg.herokuapp.com?font=JetBrains+Mono&weight=600&size=26&duration=4000&pause=1050&color=AE75DA&center=true&width=435&lines=print+(%22Olá+Mundo!%22);print+(%22Eu+sou+a+Raphaela!%22)" />
  </a>
</div>
...
```javascript
// 💻 Modo desenvolvedora: sempre ativo
// ☕ Aprendendo, criando e tomando cafeína constantemente

const raphaela = {
  estudando: "Análise e Desenvolvimento de Sistemas na FATEC Prof. Jessen Vidal",

  foco: ["Desenvolvimento Full Stack", "Ciência de Dados", "Inteligência Artificial"],
  softSkills: ["curiosidade", "organização", "criatividade", "proatividade"],
};
...
<img alt="NodeJs" height="30" width="40" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/nodejs/nodejs-original.svg">
<img alt="ExpressJs" height="30" width="40" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/express/express-original.svg">
<img alt="ViteJs" height="30" width="40" src="https://cdn.jsdelivr.net/gh/devicons/devicon@latest/icons/vitejs/vitejs-original.svg">
...
☕ Para curiosos:
> Tem muitos hobbies
> Introvertida, mas ama conversas profundas
> Conversa sobre tecnologia, arte e filosofia
> Escreve código em dark mode com metal e mocha
> Funciona melhor quando o mundo está dormindo
> Odeia complexidade desnecessária
> Acredita que um bom design conta uma história

! “Só mais um commit” se transformou em uma noite virada (de novo) 😅
```
